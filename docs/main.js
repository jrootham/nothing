...
var _user$project$Translations$clear = function (lang) {
	var _p0 = lang;
	if (_p0.ctor === 'En') {
		return 'Clear';
	} else {
...
var _user$project$Translations$En = {ctor: 'En'};
var _user$project$Translations$getLnFromCode = function (code) {
	var _p5 = code;
	switch (_p5) {
		case 'en':
			return _user$project$Translations$En;
		case 'fr':
			return _user$project$Translations$Fr;
		default:
			return _user$project$Translations$En;
	}
};
		...
		switch (_p0.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						text: _user$project$Translations$nothing(model.language)
					});
		}
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {language: a, text: b, visual: c, textCSS: d, themeCSS: e};
	});
var _user$project$Main$model = A5(_user$project$Main$Model, _user$project$Translations$En, '', true, 'normal', 'light');
var _user$project$Main$Set = {ctor: 'Set'};
var _user$project$Main$Reset = {ctor: 'Reset'};
var _user$project$Main$Language = function (a) {
	return {ctor: 'Language', _0: a};
};
var _user$project$Main$pickLanguage = F3(
	function (model, thisOne, labelText) {
		return A2(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$name('change-language'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Main$Language(thisOne)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$checked(
										_elm_lang$core$Native_Utils.eq(thisOne, model.language)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$page = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(model.textCSS),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(model.themeCSS),
				_1: {ctor: '[]'}
			}
		},
		{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_user$project$Translations$title(model.language)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Main$pickLanguage, model, _user$project$Translations$En, 'English'),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$pickLanguage, model, _user$project$Translations$Fr, 'Français'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$Translations$instructions(model.language)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_user$project$Translations$button(model.language)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_user$project$Translations$clear(model.language)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
